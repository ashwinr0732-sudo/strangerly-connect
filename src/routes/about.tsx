  ...
  head: () => ({
    meta: [
      { title: "About slypp" },
      {
        name: "description",
        content:
          "slypp is a place to meet new people from around the world and have real, anonymous conversations.",
      },
      { property: "og:title", content: "About slypp" },
      {
  ...
  return (
    <AppShell className="grid place-items-center px-4 py-12 sm:px-6">
      <GlassCard className="w-full max-w-md p-8 text-center">
        <SlyppLogo size="lg" showWordmark={false} className="mx-auto" />
        <h1 className="mt-6 text-2xl font-extrabold">About slypp</h1>
        <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
          slypp is a place to meet new people from around the world and have real,
